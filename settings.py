#coding=utf-8
"""
Django settings for psychosis project.
...
SECRET_KEY = '^1pj^ddh@x9)--qt3doq2)ynui=dhw$)=)p!^y@h+y*1sxo9=x'
...
# todo
MAKO_TEMPLATE_MODULE_DIR = os.path.join(PROJECT_DIR, 'templates_module', "psychosis")
...
WSGI_APPLICATION = 'psychosis.wsgi.application'
